...
describe("workflow helpers", () => {
  ...
  it("keeps the testing stage active while dependencies await confirmation", () => {
    expect(stageStatus("DEPENDENCY_APPROVAL", "TESTING")).toBe("active");
    expect(nextAction("DEPENDENCY_APPROVAL")).toBeNull();
  });
