...
def test_testing_can_wait_for_dependency_confirmation_and_resume() -> None:
    ensure_transition(TaskState.TESTING, TaskState.DEPENDENCY_APPROVAL)
    ensure_transition(TaskState.DEPENDENCY_APPROVAL, TaskState.TESTING)
